...
% sr_right : Spike rate of lick R trials in [trial, neuron, tim bin] format
% sr_left  : Spike rate of lick R trials in [trial, neuron, tim bin] format

numUnit = size(simDataset.sr_right,2); % number of unit
